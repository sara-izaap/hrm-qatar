 ...
 */
//$config['replacer'] = array();
$config['replacer'] = array('Add' => 'View', 'edit_product' => 'Edit');
/**
 * --------------------------
 * Config: Exclude
 * --------------------------
 ...
 */
$config['exclude'] = array('index','bulk');
...
$config['wrapper'] = '<span>|</span>';
$config['wrapper_inline'] = '<span>|</span>';
...
$config['unlink'] = array('Edit','attributes','categories','vendor','images','view','Edit Product Variation','edit');
